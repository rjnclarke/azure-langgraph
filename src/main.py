...
# get APIs
from azure_langchain_openai import llm
...
search_instructions = prompts.search_instructions
...
### master graph nodes and conditional functions ###
...
### Compile sub-graph
# Add nodes and edges
print('Creating interview sub-graph...')
